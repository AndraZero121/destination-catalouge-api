...
<div class="auth-shell" data-aos="fade-up">
    ...
    <h1 class="text-2xl font-semibold text-[#1f5f1c]">Register Destin.id</h1>
    <p class="text-sm text-slate-500 mt-2">Create your Account</p>

    <div class="auth-card mt-6" data-aos="fade-up">
        <form id="register-form" class="space-y-4">
            <input id="name" required placeholder="Name" class="auth-input" />
            <input id="email" type="email" required placeholder="Email" class="auth-input" />
            <input id="phone" required placeholder="Phone" class="auth-input" />
            <input id="password" type="password" required placeholder="Password" class="auth-input" />
            <input id="password_confirmation" type="password" required placeholder="Confirm Password" class="auth-input" />

            <button type="submit" class="auth-btn">Register</button>
            <a href="/login" class="auth-secondary inline-flex items-center justify-center">Back to login</a>
        </form>
